...
This behavior will be permanent for the remainder of the session.
----------------
{context}`;
    const messages = [
    ...
    const answer = await chain.invoke(
      `Generate a Dockerfile for ${words} based on my code snippet's Dockerfile. Use the same version as my code snippet's Dockerfile.`
    );
